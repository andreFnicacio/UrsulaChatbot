...
var checkConnectionSession = require("../api/checkStatusSession");
var closeSession = require("../api/closeSession");
var updateClient = require("../api/updateClient");
function checkClientExists(_x) {
  ...
  _isSessionActive = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(client) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return checkConnectionSession(client.id_session, client.token);
        case 2:
...
function handleInactiveSession(_x3, _x4) {
  return _handleInactiveSession.apply(this, arguments);
}
function _handleInactiveSession() {
  _handleInactiveSession = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(client, sessionKey) {
