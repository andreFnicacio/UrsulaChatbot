...
function _status() {
  _status = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var status, type, session, user, phone, token, textSubmit, textClient, decision_tree_way, button, updateData, operationList, _updateData, _textSubmit;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          token = user.token;
          if (type === "text/csv") {
            textSubmit = whatsappModel.MessageText("Lista de Leads Cadastrados!! Ja est\xE1 disponivel para o disparo de campanhas \uD83E\uDD70", phone);
          ...
          textClient = "Oii ".concat(user.name, ", tudo bem?! Tivemos um problema na hora da leitura do Qr Code \uD83E\uDD7A!\nGostaria de tentar novamente ?");
...
function delayedFunction() {
  return _delayedFunction.apply(this, arguments);
}
function _delayedFunction() {
  _delayedFunction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
