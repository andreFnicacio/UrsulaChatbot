...
function _uploadImage() {
  _uploadImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(session) {
    var file,
      filePath,
      formData,
      config,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          file = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
          filePath = file === false ? "qrcode_".concat(session, ".png") : file; // Verifica se o arquivo existe
        ...
        case 5:
          ...
          formData.append('file', fs.createReadStream(filePath), {
            filename: "qrcode_".concat(session, ".png"),
          ...
          _context.prev = 9;
          _context.next = 12;
          return axios.post("https://graph.facebook.com/v18.0/262715723599699/media", formData, config);
        case 12:
        ...
        case 16:
          ...
          if (_context.t0.response) {
            console.error('Upload failed:', _context.t0.response.data);
          } else {
